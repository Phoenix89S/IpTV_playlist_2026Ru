...
def main() -> None:
    ...
    print(
        f"║ Services:     {len(inventory['service_ids']):<26} ║"
    )

    print(
        f"║ Channels:     {len(inventory['channels']):<26} ║"
    )

    print(
        f"║ URLs:         {len(entries):<26} ║"
    )
    ...
    print(
        f"║ M3U:          {m3u_path.name:<26} ║"
    )

    print(
        f"║ JSON:         {json_path.name:<26} ║"
    )

    print(
        f"║ SKALA:        {report_path.name:<26} ║"
    )

    print(
        f"║ HISTORY:      {history_path.name:<26} ║"
    )
