#!/usr/bin/env python3
# Denis IPTV Builder / iptv_parser_v8_full.py
...
def merge_channels(
    ...
    srcA_channels: List[Channel],
    srcB_channels: List[Channel],
    commitsA: List[Channel],
    commitsB: List[Channel],
) -> List[Channel]:
    result: List[Channel] = []
    global_counter = 1
