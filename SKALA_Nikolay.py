...
01:23:40.0  СИГНАЛ    НАЖАТИЕ_КНОПКИ_АЗ_5    =  АКТИВЕН
01:23:40.0  КОМАНДА   СБРОС_ВСЕХ_ГРУПП_СУЗ   =  АКТИВЕН
01:23:41.0  ПАРАМЕТР  H_СУЗ_ГЛУБИНА_СРЕДН    =  0.8     М

01:23:43.0  СИГНАЛ    АП_ПЕРИОД              =  АКТИВЕН (АВАРИЙНЫЙ ПЕРИОД РАЗГОНА < 20 СЕК)
01:23:43.0  СИГНАЛ    АП_МОЩНОСТЬ            =  АКТИВЕН (АВАРИЙНОЕ ПРЕВЫШЕНИЕ МОЩНОСТИ)
01:23:43.0  ПАРАМЕТР  N_ТЕПЛ_РЕАКТОР         =  РОСТ > 500 МВТ(Т)

01:23:44.0  ПАРАМЕТР  H_СУЗ_ГЛУБИНА_СРЕДН    =  2.0     М (ЗАКЛИНИВАНИЕ СТЕРЖНЕЙ СУЗ)
01:23:44.0  СИГНАЛ    СУЗ_НЕИСПРАВНОСТЬ_ОТКЛ_МУФТ
01:23:44.2  ПАРАМЕТР  N_ТЕПЛ_РЕАКТОР         =  ЗНАЧЕНИЕ_ВНЕ_ШКАЛЫ_ПРИБОРОВ (ЗАШКАЛИВАНИЕ)

01:23:45.0  СИГНАЛ    Р_БС_ЛЕВ_ПОВЫШ_КРИТ    =  7.5     МПА
01:23:45.0  СИГНАЛ    Р_БС_ПРАВ_ПОВЫШ_КРИТ   =  7.5     МПА
01:23:45.2  КОМАНДА   ОТКРЫТИЕ_ПК_ГПК        =  АКТИВЕН (ОТКРЫТИЕ ПРЕДОХРАНИТЕЛЬНЫХ КЛАПАНОВ)

01:23:46.0  СИГНАЛ    G_ГЦН_11_СНИЖ_КРИТ     <  1500    М3/Ч (КАВИТАЦИЯ НАСОСОВ)
01:23:46.2  СИГНАЛ    G_ГЦН_21_СНИЖ_КРИТ     <  1500    М3/Ч
01:23:46.5  СИГНАЛ    G_ГЦН_12_СНИЖ_КРИТ     <  1500    М3/Ч
01:23:46.8  СИГНАЛ    G_ГЦН_22_СНИЖ_КРИТ     <  1500    М3/Ч
01:23:47.0  СИГНАЛ    РАСХОД_КМПЦ_ОБЩИЙ      =  ОТКАЗ_ДАТЧИКОВ (ПАРОГАЗОВАЯ СМЕСЬ В КОНТУРЕ)

01:23:47.5  СИГНАЛ    Р_РП_АВАР_ПОВЫШ        =  АКТИВЕН (РОСТ ДАВЛЕНИЯ В РЕАКТОРНОМ ПРОСТРАНСТВЕ)
01:23:47.8  СИГНАЛ    РАЗРЫВ_ТЕХНОЛОГИЧ_КАНАЛОВ_ГРУППА_А

01:23:48.0  СИГНАЛ    СУЗ_ОБРЫВ_КАБЕЛЕЙ_ДАТЧИКОВ_ПОЛОЖЕНИЯ (ОБРЫВ ПРОВОДОВ НАД ПЛИТОЙ РЕАКТОРА)
01:23:48.2  СИГНАЛ    ОБРЫВ_КАНАЛОВ_ИЗМЕРЕНИЯ_ДРГ_1
01:23:48.5  СИГНАЛ    ОБРЫВ_КАНАЛОВ_ИЗМЕРЕНИЯ_ДРГ_2

01:23:49.0  СИГНАЛ    НЕТ_ОПРОСА_ТГ_8
01:23:49.0  СИГНАЛ    НЕТ_НАПРЯЖЕНИЯ_СУУ_СКАЛА
01:23:49.0  СИГНАЛ    КРАХ_ОПЕРАЦИОННОЙ_СИСТЕМЫ_ИВС
01:23:49.2  СИГНАЛ    ОТКАЗ_ОПРОСА_ТП (ТЕПЛОТЕХНИЧЕСКИХ ПАРАМЕТРОВ)

================================================================================
01:23:49.2  *** СВЯЗЬ С ДАТЧИКАМИ ПРЕРВАНА ***
01:23:49.2  *** РЕГИСТРАЦИЯ ПРЕКРАЩЕНА ПО ПРИЧИНЕ ФИЗИЧЕСКОГО РАЗРУШЕНИЯ ИВС ***
================================================================================
